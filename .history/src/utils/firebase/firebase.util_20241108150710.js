...
import { collectionGroup, doc, getDoc, getFirestore, setDoc } from "firebase/firestore";
...
export const addCollectionAndDocuments = (collection, objectsToAdd)=>{
  const collectionRef = collection(db, co);
}
